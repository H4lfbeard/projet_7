 ...
 */
class CostumerRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Costumer $entity, bool $flush = false): void
    {
    ...
    public function remove(Costumer $entity, bool $flush = false): void
    {
